...
export CONTROLLER_PUBLIC_IP=35.174.130.176
export CONTROLLER0_PRIVATE_IP=172.31.112.82
export CONTROLLER1_PRIVATE_IP=172.31.117.72

export WORKER0_PUBLIC_IP=52.55.121.63
export WORKER0_PRIVATE_IP=172.31.118.150

export WORKER1_PUBLIC_IP=54.164.190.173
export WORKER1_PUBLIC_IP=IP

export KUBE_APISERVER_SERVICE_IP=10.200.0.1
export KUBE_DNS_SERVICE_IP=10.200.0.33

export CLUSTER_DOMAIN=kubecluster.local
...
## CONTAINERD
export CONTAINERD_GITHUB=https://github.com/containerd/containerd/releases/download/v1.1.0/containerd-1.1.0.linux-amd64.tar.gz
export CONTAINERD_TARBALL_NAME=containerd-1.1.0.linux-amd64.tar.gz
